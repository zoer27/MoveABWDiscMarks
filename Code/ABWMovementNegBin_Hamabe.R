###ABW Movement Model fitting to Hamabe 2023 Abundance Data
...
Abund_Est_Mat_Ind<-Abund_dat$PopSize[which(Abund_dat$Source == "Hamabe" & Abund_dat$Basin == "Indian")]
Abund_Est_Mat_Pac<-Abund_dat$PopSize[which(Abund_dat$Source == "Hamabe" & Abund_dat$Basin == "Pacific")]
...
In_year_Mat<-Abund_dat$Year[which(Abund_dat$Basin == "Indian" & Abund_dat$Source == "Hamabe")]
Pac_year_Mat<-Abund_dat$Year[which(Abund_dat$Basin == "Pacific" & Abund_dat$Source == "Hamabe")] #survey yeas in the Pacific 
